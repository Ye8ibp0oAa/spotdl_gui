...
class SpotDLGUI(QMainWindow):
    ...
    def initUI(self):
        ...
        self.format_combo.addItems(['mp3', 'm4a', 'flac', 'opus', 'ogg', 'wav'])
        ...
        self.bitrate_combo.addItems([' best', ' 320k', ' 256k', ' 192k', ' 128k'])
        self.bitrate_combo.setCurrentIndex(0)  # Default to best
